...
[dir] .q-field--readonly.q-field--labeled .q-field__native {
  cursor: default;
}
[dir] .q-field--readonly.q-field--float .q-field__native {
  cursor: text;
}
...
[dir=rtl] .q-field__label {
  ...
  transition: transform 0.36s cubic-bezier(0.4, 0, 0.2, 1), left 0.36s cubic-bezier(0.4, 0, 0.2, 1);
}
...
[dir] .q-select.q-field--readonly.q-field--labeled .q-select__input {
  cursor: default;
}
[dir] .q-select.q-field--readonly.q-field--float .q-select__input {
  cursor: text;
}
.q-select__dialog {
...
[dir] body.desktop .q-toggle--dense:focus:not(.disabled) .q-toggle__thumb:before {
  transform: scale3d(1.5, 1.5, 1.5);
}
.q-toolbar {
  position: relative;
