...
(function (global, factory) {
  ...
  var notPassive = listenOpts.notPassive;
        ...
        if (context === true) {
          if (this.$q.platform.is.mobile === true) {
            ...
            ;['touchcancel', 'touchmove', 'touchend'].forEach(function (evt) {
              this$1.anchorEl.removeEventListener(evt, this$1.__mobileCleanup, passive);
            });
          }
          else {
      ...
      __configureAnchorEl: function __configureAnchorEl (context) {
        ...
        if (context === true) {
          if (this.$q.platform.is.mobile === true) {
            ...
            ;['touchcancel', 'touchmove', 'touchend'].forEach(function (evt) {
              this$1.anchorEl.addEventListener(evt, this$1.__mobileCleanup, passive);
            });
          }
          else {
  ...
  var notPassiveCapture$1 = listenOpts.notPassiveCapture;
    ...
    bind: function bind (el, ref) {
      ...
      var ctx = {
        ...
        move: function move (evt) {
          ...
          if (ctx.event.dir !== false) {
            stopAndPrevent(evt);
            document.addEventListener('click', stopAndPrevent, notPassiveCapture$1);
          ...
          if (ctx.event.dir !== false) {
            stopAndPrevent(evt);
            setTimeout(function () {
              document.removeEventListener('click', stopAndPrevent, notPassiveCapture$1);
            }, 50);
  ...
  var notPassiveCapture$2 = listenOpts.notPassiveCapture;
      ...
      var ctx = {
        ...
        touchMove: function touchMove (evt) {
          ...
          if (ctx.event !== void 0 && ctx.event.detected === true) {
            el.removeEventListener('touchmove', ctx.touchMove, notPassiveCapture$2);
        ...
        move: function move (evt) {
          ...
          if (ctx.event.mouse !== true && ctx.event.detected === true) {
            el.addEventListener('touchmove', ctx.touchMove, notPassiveCapture$2);
          }
  ...
  */
      ...
      __updateMaskValue: function __updateMaskValue (rawVal, updateMaskInternals) {
        ...
        this.$nextTick(function () {
          if (this$1.reverseFillMask === true) {
            if (changed === true) {
              var cursor = Math.max(0, masked.length - (masked === this$1.maskReplaced ? 0 : Math.min(preMasked.length, oldCursor + 1)));
            ...
            if (masked === this$1.maskReplaced) {
              ...
              var cursor$2 = Math.max(0, this$1.maskMarked.indexOf(MARKER), Math.min(preMasked.length, oldCursor) - 1);
  ...
  var QTooltip = Vue.extend({
    ...
    methods: {
      ...
      __unconfigureAnchorEl: function __unconfigureAnchorEl () {
        ...
        if (this.$q.platform.is.mobile === true) {
          this.anchorEl.removeEventListener('touchstart', this.__delayShow, passive$1)
          ;['touchcancel', 'touchmove', 'click'].forEach(function (evt) {
            this$1.anchorEl.removeEventListener(evt, this$1.__delayHide, passive$1);
          });
        }
        else {
          this.anchorEl.removeEventListener('mouseenter', this.__delayShow, passive$1);
        }

        if (this.$q.platform.is.ios !== true) {
          this.anchorEl.removeEventListener('mouseleave', this.__delayHide, passive$1);
        }
      },
      ...
      __configureAnchorEl: function __configureAnchorEl () {
        ...
        if (this.$q.platform.is.mobile) {
          this.anchorEl.addEventListener('touchstart', this.__delayShow, passive$1)
          ;['touchcancel', 'touchmove', 'click'].forEach(function (evt) {
            this$1.anchorEl.addEventListener(evt, this$1.__delayHide, passive$1);
          });
        }
        else {
          this.anchorEl.addEventListener('mouseenter', this.__delayShow, passive$1);
        }
      ...
      __unconfigureScrollTarget: function __unconfigureScrollTarget () {
        ...
        window.removeEventListener('scroll', this.updatePosition, passive$1);
      },
    ...
    methods: {
      ...
      getTableBody: function getTableBody (h) {
        ...
        var
          ...
          mapFn = body !== void 0
            ? function (row) { return this$1.getTableRowBody(h, row, body); }
      ...
      getTableRowVirtual: function getTableRowVirtual (h) {
        ...
        return body !== void 0
          ? function (props) { return this$1.getTableRowBody(h, props.item, body); }
  ...
  var TableGrid = {
    methods: {
      getGridBody: function getGridBody (h) {
        ...
        return h('div', { staticClass: 'row' }, this.computedRows.map(function (row) {
          var
  ...
  function globalDialog (DefaultComponent) {
    return function (ref) {
      ...
      var rest = objectWithoutProperties( ref, ["className", "class", "style", "component", "root", "parent"] );
      var props = rest;
